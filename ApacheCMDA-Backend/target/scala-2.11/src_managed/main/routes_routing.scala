...
// @LINE:56
private[this] lazy val controllers_UserController_addDummyUser38_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("addDummyUser"))))
private[this] lazy val controllers_UserController_addDummyUser38_invoker = createInvoker(
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).addDummyUser(),
HandlerDef(this.getClass.getClassLoader, "", "controllers.UserController", "addDummyUser", Nil,"GET", """""", Routes.prefix + """addDummyUser"""))
...
// @LINE:62
private[this] lazy val controllers_PostController_addPost40_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("post"))))
private[this] lazy val controllers_PostController_addPost40_invoker = createInvoker(
...
HandlerDef(this.getClass.getClassLoader, "", "controllers.PostController", "addPost", Nil,"POST", """ Post""", Routes.prefix + """post"""))
        

// @LINE:63
private[this] lazy val controllers_PostController_addPostTest41_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("post/test"))))
private[this] lazy val controllers_PostController_addPostTest41_invoker = createInvoker(
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.PostController]).addPostTest(),
HandlerDef(this.getClass.getClassLoader, "", "controllers.PostController", "addPostTest", Nil,"GET", """""", Routes.prefix + """post/test"""))
        

// @LINE:64
private[this] lazy val controllers_PostController_getPost42_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("post/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_PostController_getPost42_invoker = createInvoker(
...
HandlerDef(this.getClass.getClassLoader, "", "controllers.PostController", "getPost", Seq(classOf[Long], classOf[String]),"GET", """""", Routes.prefix + """post/$id<[^/]+>"""))
        

// @LINE:65
private[this] lazy val controllers_PostController_getAllPostsByUserId43_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("posts/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_PostController_getAllPostsByUserId43_invoker = createInvoker(
...
// @LINE:56
case controllers_UserController_addDummyUser38_route(params) => {
   call { 
        controllers_UserController_addDummyUser38_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).addDummyUser())
   }
}
...
// @LINE:62
case controllers_PostController_addPost40_route(params) => {
   call { 
        controllers_PostController_addPost40_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.PostController]).addPost())
   }
}
        

// @LINE:63
case controllers_PostController_addPostTest41_route(params) => {
   call { 
        controllers_PostController_addPostTest41_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.PostController]).addPostTest())
   }
}
        

// @LINE:64
case controllers_PostController_getPost42_route(params) => {
   call(params.fromPath[Long]("id", None), Param[String]("format", Right("json"))) { (id, format) =>
        controllers_PostController_getPost42_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.PostController]).getPost(id, format))
   }
}
        

// @LINE:65
case controllers_PostController_getAllPostsByUserId43_route(params) => {
   call(params.fromPath[Long]("id", None), Param[String]("format", Right("json"))) { (id, format) =>
        controllers_PostController_getAllPostsByUserId43_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.PostController]).getAllPostsByUserId(id, format))
   }
}
