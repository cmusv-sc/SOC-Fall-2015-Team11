...
// @LINE:61
private[this] lazy val controllers_PostController_addPost39_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("post"))))
private[this] lazy val controllers_PostController_addPost39_invoker = createInvoker(
...
// @LINE:62
private[this] lazy val controllers_PostController_addPostTest40_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("post/test"))))
private[this] lazy val controllers_PostController_addPostTest40_invoker = createInvoker(
...
// @LINE:63
private[this] lazy val controllers_PostController_getPost41_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("post/"),DynamicPart("id", """[^/]+""",true))))
...
// @LINE:61
case controllers_PostController_addPost39_route(params) => {
   call { 
        controllers_PostController_addPost39_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.PostController]).addPost())
   }
}
        

// @LINE:62
case controllers_PostController_addPostTest40_route(params) => {
   call { 
        controllers_PostController_addPostTest40_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.PostController]).addPostTest())
   }
}
